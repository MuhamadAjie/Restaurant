...
import com.ajie.ajieresto.adapter.RestaurantAdapter;
import com.ajie.ajieresto.data.Session;
import com.ajie.ajieresto.model.ListRestaurantResponse;
import com.androidnetworking.AndroidNetworking;
import com.androidnetworking.error.ANError;
import com.androidnetworking.interfaces.ParsedRequestListener;

import static com.ajie.ajieresto.data.Constans.CREATE_RESTAURANT;
import static com.ajie.ajieresto.data.Constans.DELETE_RESTAURANT;
import static com.ajie.ajieresto.data.Constans.GET_LIST_RESTAURANT;
import static com.ajie.ajieresto.data.Constans.GET_SEARCH_RESTAURANT;
        ...
        switch (item.getItemId()) {
            ...
            case R.id.tambahResto:
                AndroidNetworking.post(CREATE_RESTAURANT)
                        ...
                        .addBodyParameter("namarm","Ajie Resto")
                        .addBodyParameter("kategori","Restoran")
                        .addBodyParameter("link_foto","https://images.app.goo.gl/xaYghqa4AUysmox28")
